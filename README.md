...
[![Issues](https://img.shields.io/github/issues/hoop33/limo.svg)](https://github.com/sniperkit/limo/issues)
...
```sh
$ go get -u github.com/sniperkit/limo
```

You can also download a pre-built binary for your platform and copy it to a location on your path.

* [macOS](https://github.com/sniperkit/limo/raw/master/dist/macos/limo)
* [Linux](https://github.com/sniperkit/limo/raw/master/dist/linux/limo)
* [Windows](https://github.com/sniperkit/limo/raw/master/dist/windows/limo.exe)
